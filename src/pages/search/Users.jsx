...
const Users = () => {
  ...
  // const datahis = useSelector((state) => state.searchUsers.dataHistory)
  // console.log(datahis);
  ...
  return (
    <div>
      <div className="flex justify-between items-start px-[10%] py-[7vh] ">
        <div className="w-[24%] mt-[5px]">
          {dataUserId.image === "" ? (
            ...
            <img
              id="ibo"
              className="rounded-full cursor-pointer w-[100%]  h-[31vh] object-cover"
              src={`${import.meta.env.VITE_APP_FILES_URL}${dataUserId.image}`}
              alt={"profile"}
            />
          )}
        </div>
      ...
      <div className="flex justify-between items-center flex-wrap gap-[10px_0] px-[1%] py-[5vh]">
            ...
            >
              {postId.map((e, i) => {
                return (
                  <div
                    key={e.postId}
                    className="w-[33%] h-[55vh] text-center mt-[5px]"
                  >
                    <div className="w-[26%] flex flex-col items-center justify-center text-[#00000000] hover:text-[white]  h-[55vh] hover:bg-[#0000006d] absolute ">
